...
def create_corner_labels(point_clouds, wf_vertices, distance_threshold=0.05, soft_labels=True):
    """
    Create corner labels with soft labeling and better distance handling
